...
public class FuncionarioRepository {
    ...
    public List<Funcionario> findAll() throws SQLException {
        String sql = "SELECT f.id as id_f, f.departamento, f.cargo, f.salario, f.turno, f.admissao, f.pessoa_id, p.nome, p.email, p.cpf, p.telefone, p.nascimento " +
                "FROM FUNCIONARIO f join PESSOA p ON f.pessoa_id = p.id ORDER BY p.nome";
